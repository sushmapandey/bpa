    ...
    <section class="bpa-founders container">
      ...
      <div class="bpa-section ">
        ...
        <div class="about-content">
          <h3>bharthi prem</h3>
          <span class="header-underline"></span>
          <h4>leed ap<span>(Leadership in Energy and Environmental Design )</span> </h4>
          <p class="lead">Bharathi Prem is one of the leading 
          ...
          <a href="<?php echo home_url('bharathi_prem'); ?>" class="btn btn-outline plr">Read More <i class="fas fa-chevron-right"></i></a>
        </div>
      ...
      <div class="bpa-section ">
        ...
        <div class="about-content prem-content">
          ...
          <span class="header-underline"></span>
          <h4>be Civil</h4>
          <p class="lead">BA Civil Engineer by Profession, a Post graduate in Management, Public speaker, Psychotherapist and Counsellor.</p>
...
<section class="bpa-project">
  <div class="bpa-projects-img container">   
